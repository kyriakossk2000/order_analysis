...
# Based on EDA, the best features seem to be ITEM_COUNT)
...
def evaluate_models(models, X_test, y_test, scalers):
    ...
    for model_name, model in models.items():
        ...
        mae = mean_absolute_error(y_test, y_pred) # close to 0 -> better
        mse = mean_squared_error(y_test, y_pred) # close to 0 -> better
        r2 = r2_score(y_test, y_pred)  # best score 1, can be negative
